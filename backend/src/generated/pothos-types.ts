...
export default interface PrismaTypes {
    ...
    OAuthClient: {
        ...
        Create: {};
        Update: {};
        RelationName: "authorizationCodes" | "accessTokens";
        ListRelations: "authorizationCodes" | "accessTokens";
        Relations: {
            authorizationCodes: {
                Shape: OAuthAuthorizationCode[];
                Name: "OAuthAuthorizationCode";
