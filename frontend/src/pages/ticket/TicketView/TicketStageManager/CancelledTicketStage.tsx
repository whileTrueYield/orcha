...
export const CancelledTicketStage: FCWithFragments<Props> = (props) => {
...
CancelledTicketStage.fragments = {
  cancelledTicketStageFragment: gql`
    fragment cancelledTicketStageFragment on Ticket {
      id
