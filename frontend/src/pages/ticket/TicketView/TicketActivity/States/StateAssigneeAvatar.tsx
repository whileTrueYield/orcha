...
export const StateAssigneeAvatar: FCWithFragments<Props> = (props) => {
  const { role } = props;
  ...
  return (
    ...
    >
      <Avatar
        src={role.avatarUrl}
        name={role.name}
        className="mr-2 h-10 w-10 shrink-0 rounded-md"
      />
...
StateAssigneeAvatar.fragments = {
  StateAssigneeAvatarFragment: gql`
    fragment StateAssigneeAvatarFragment on Role {
      id
      name
      avatarUrl
      title
