...
export const IssueActionTicket: React.FC<Props> = (props) => {
  const { action } = props;

  if (action.category !== IssueActionCategory.SetTicket) {
    console.warn("IssueActionTicket was used to display a", action.category);
    return null;
  }
