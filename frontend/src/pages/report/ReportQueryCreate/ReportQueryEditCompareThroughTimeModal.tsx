...
const schema = yup
  ...
  .shape({
    ...
    secondaryChartBy: reportQueryFormFields.chartByDate,
...
export const ReportQueryEditCompareThroughTimeModal: FCWithFragments<Props> = (
  props
) => {
        ...
        >
          ...
          <div className="mt-3 flex-1 sm:mt-0 sm:ml-4">
            <div className="space-y-4">
              ...
              >
                Edit Compare Through Time Widget
              </Dialog.Title>
...
const UPDATE_REPORT_QUERY_MUTATION = gql`
  mutation UpdateReportQueryForCompareThroughTime(
    $reportQueryId: Int!
...
ReportQueryEditCompareThroughTimeModal.fragments = {
  ReportQueryEditCompareThroughTimeModalFragment: gql`
    fragment ReportQueryEditCompareThroughTimeModalFragment on ReportQuery {
      id
      title
      aggregateField
      cummulative
