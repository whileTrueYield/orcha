...
export const ReportQueryCreateValuesThroughTimeModal: React.FC<Props> = (
  props
) => {
  const { report } = props;
    ...
    createReportQuery({
      variables: {
        ...
        input: {
          ...
          noUnknowns: true,
          widgetType: ReportWidgetType.ValuesThroughTime,
          ...filter.dates,
        },
      },
    });
        ...
        >
          ...
          <div className="mt-3 flex-1 sm:mt-0 sm:ml-4">
            <div className="space-y-4">
              ...
              >
                New Values Through Time Widget
              </Dialog.Title>
...
const CREATE_REPORT_QUERY_MUTATION = gql`
  mutation CreateReportQueryValuesThroughTime(
    $reportId: Int!
