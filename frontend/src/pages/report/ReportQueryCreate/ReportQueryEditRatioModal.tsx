...
export const ReportQueryEditRatioModal: FCWithFragments<Props> = (props) => {
...
const UPDATE_REPORT_QUERY_MUTATION = gql`
  mutation UpdateReportQueryForRatio(
    $reportQueryId: Int!
...
ReportQueryEditRatioModal.fragments = {
  ReportQueryEditValuesModalFragment: gql`
    fragment ReportQueryEditValuesModalFragment on ReportQuery {
      id
      title
      aggregateField
      chartBy
