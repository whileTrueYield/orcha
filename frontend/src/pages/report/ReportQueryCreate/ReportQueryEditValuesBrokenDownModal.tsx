...
export const ReportQueryEditValuesBrokenDownModal: FCWithFragments<Props> = (
  props
) => {
...
const UPDATE_REPORT_QUERY_MUTATION = gql`
  mutation UpdateReportQueryForValuesBrokenDown(
    $reportQueryId: Int!
...
ReportQueryEditValuesBrokenDownModal.fragments = {
  ReportQueryEditValuesBrokenDownModalFragment: gql`
    fragment ReportQueryEditValuesBrokenDownModalFragment on ReportQuery {
      id
      title
      aggregateField
      chartBy
