...
import { ReportQuery, MutationUpdateReportQueryArgs } from "types/graphql";
...
import { DatumGranularity } from "../formater/helpers";
...
export const ReportQueryEditCalendarModal: FCWithFragments<Props> = (props) => {
...
const UPDATE_REPORT_QUERY_MUTATION = gql`
  mutation UpdateReportQueryForCalendar(
    $reportQueryId: Int!
...
ReportQueryEditCalendarModal.fragments = {
  ReportQueryEditCalendarModalFragment: gql`
    fragment ReportQueryEditCalendarModalFragment on ReportQuery {
      id
      title
      aggregateField
      cummulative
